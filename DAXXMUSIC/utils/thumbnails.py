...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("SPEEDMUSIC/assets/assets/font2.ttf", 30)
    font = ImageFont.truetype("SPEEDMUSIC/assets/assets/font.ttf", 30)
    title_font = ImageFont.truetype("SPEEDMUSIC/assets/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("SPEEDMUSIC/assets/assets/play_icons.png")
